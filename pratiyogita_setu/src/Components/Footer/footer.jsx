    ...
    <footer className="w-full relative overflow-hidden" style={{background: 'linear-gradient(to top, rgba(249,115,22,0.18) 60%, transparent 100%)'}}>
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8 md:py-10">
            ...
            <div className="space-y-5">
              ...
              <div>
                <a href={PRATIYOGITA_YOGYA_URL} className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className={`text-base sm:text-lg font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Pariksha Yogya</span>
                </a>
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed text-justify`}>
                  {language === "en"
              ...
              <div>
                <a href={PRATIYOGITA_MARG_URL} className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className={`text-base sm:text-lg font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Pariksha Marg</span>
                </a>
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed text-justify`}>
                  {language === "en"
              ...
              <div>
                <a href={PRATIYOGITA_GYAN_URL} className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className={`text-base sm:text-lg font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Pariksha Gyan</span>
                </a>
                <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed text-justify`}>
                  {language === "en"
          ...
          <div>
            ...
            <div className="mb-4">
              <Link to="/" className="flex items-center gap-2 mb-2">
                ...
                <span className={`text-base sm:text-lg font-bold ${isDark ? "text-white" : "text-gray-900"}`}>Pariksha Setu</span>
              </Link>
              <p className={`text-sm ${isDark ? "text-gray-300" : "text-gray-600"} leading-relaxed text-justify`}>
                {language === "en"
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 mb-5">
              <a href="mailto:askparikshasetu@gmail.com" className={`${isDark ? "text-gray-400 hover:text-indigo-400" : "text-gray-500 hover:text-indigo-600"} transition-colors duration-300`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                  <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                </svg>
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className={`${isDark ? "text-gray-400 hover:text-blue-400" : "text-gray-500 hover:text-blue-600"} transition-colors duration-300`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z" />
                </svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className={`${isDark ? "text-gray-400 hover:text-white" : "text-gray-500 hover:text-black"} transition-colors duration-300`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className={`${isDark ? "text-gray-400 hover:text-pink-400" : "text-gray-500 hover:text-pink-600"} transition-colors duration-300`}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
              <Link to="/" className={`${isDark ? "text-gray-300 hover:text-orange-400" : "text-gray-600 hover:text-orange-500"} hover:underline transition-colors`}>
                {language === "en" ? "Home" : "होम"}
              </Link>
              <Link to="/about" className={`${isDark ? "text-gray-300 hover:text-orange-400" : "text-gray-600 hover:text-orange-500"} hover:underline transition-colors`}>
                {language === "en" ? "About Us" : "हमारे बारे में"}
              </Link>
              <Link to="/contribution" className={`${isDark ? "text-gray-300 hover:text-orange-400" : "text-gray-600 hover:text-orange-500"} hover:underline transition-colors`}>
                {language === "en" ? "Contribution" : "योगदान"}
              </Link>
              <Link to="/contact" className={`${isDark ? "text-gray-300 hover:text-orange-400" : "text-gray-600 hover:text-orange-500"} hover:underline transition-colors`}>
        ...
        <div className="border-t border-orange-500/40 mt-6 pt-3">
          <div className="flex flex-col sm:flex-row justify-between items-center text-white/70 text-xs sm:text-sm">
