...
function RefundPolicy() {
  ...
  const sectionContent = {
    ...
    subscription: (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          ...
          <h2 className="text-xl font-bold text-gray-800">Subscription Services</h2>
        </div>
    ...
    "one-time": (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          ...
          <h2 className="text-xl font-bold text-gray-800">One-Time Purchases</h2>
        </div>
        <p className="mb-2 text-gray-700">
    ...
    eligibility: (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          ...
          <h2 className="text-xl font-bold text-gray-800">Eligibility for Refunds</h2>
        </div>
        <p className="mb-2 text-gray-700">Refunds may be considered in the following circumstances:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    "non-refundable": (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          ...
          <h2 className="text-xl font-bold text-gray-800">Non-Refundable Items</h2>
        </div>
        <p className="mb-2 text-gray-700">The following are generally not eligible for refunds:</p>
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
    ...
    request: (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          ...
          <h2 className="text-xl font-bold text-gray-800">How to Request a Refund</h2>
        </div>
        <p className="mb-2 text-gray-700">
    ...
    changes: (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          <div className="p-1.5 mr-3 bg-cyan-100 rounded-lg text-cyan-600">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    contact: (
      <div className="flex flex-col">
        <div className="flex items-center mb-3">
          <div className="p-1.5 mr-3 bg-teal-100 rounded-lg text-teal-600">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="bg-white min-h-screen pt-14">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <p className="text-sm text-gray-500 mt-8 text-right">Last Updated: April 7, 2025</p>
      </div>
