...
const Footer = () => {
  return (
    <div className="relative bg-white/5 backdrop-blur-sm border border-orange-500/40 py-3 overflow-hidden rounded-2xl mx-4 sm:mx-8 md:mx-12 lg:mx-20 mb-4">
      <div className="relative z-10 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start py-4">
          {/* Left Section */}
          <div className="w-full flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-md lg:max-w-xl text-white/80 mb-4">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-1.5 mb-2">
              <span className="text-white/60 text-sm">For help and support:</span>
              <a href="mailto:askparikshasetu@gmail.com" className="text-orange-400 hover:underline text-sm break-all">
          ...
          {/* Right Section */}
          <div className="w-full flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="inline-block bg-orange-500/20 border border-orange-500/40 rounded-lg px-2 py-0.5 mb-4">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-2 text-white/70 text-sm">
              <Link to="/" className="hover:text-orange-400 hover:underline">Home</Link>
              <Link to="/about" className="hover:text-orange-400 hover:underline">About Us</Link>
              <Link to="/contribution" className="hover:text-orange-400 hover:underline">Contribution</Link>
              <Link to="/contact" className="hover:text-orange-400 hover:underline">Contact Us</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 border-t border-orange-500/40 mt-1 pt-3">
        <div className="flex flex-col sm:flex-row justify-between items-center px-6 max-w-7xl mx-auto text-white/50 text-sm">
          <div>Made with ❤️ for Aspirants</div>
          <div className="mt-1 sm:mt-0">
            © {new Date().getFullYear()} | 
            <Link to="/privacy-policy" className="underline hover:text-orange-400 ml-1">Privacy Policy</Link> | 
