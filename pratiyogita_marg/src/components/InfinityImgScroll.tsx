...
const InfinityImgScroll = () => {
  ...
  useEffect(() => {
    ...
    const scroll = () => {
      ...
      if (scrollTrack.firstChild && scrollPos >= (scrollTrack.firstChild as HTMLElement).offsetWidth) {
        scrollPos = 0;
      }
  ...
  return (
    <div className="w-full py-5 overflow-x-hidden">
      <h2 className="text-2xl md:text-3xl font-bold mb-6 md:mb-10 text-gray-900 text-center">Supported Exams</h2>
